       ...
       /* public 借阅(string CardID)
        ...
        private void init()
        {
            ...
            try
            {
                ...
                sql = String.Format(sql, this.CardID.Text);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    dr.Close();
                    if (BookNum.Text != "" && BookNum.Text != ";" && CardID.Text != "" && CardID.Text != "@") { 
                    cmdstr = "insert into BorrowTable(CardID,BookNum,BorrowDate,ReturnState) values('{0}','{1}','{2}','未还')";
                    cmdstr = string.Format(cmdstr, CardID.Text, BookNum.Text, DateTime.Now.ToString("yyyy/MM/dd"));
                    cmd = new SqlCommand(cmdstr, sqlcon);
                    int tem;
